export const ENV_CONFIG = {
    ...
    VITE_DATA_REGISTRY_ADDRESS: import.meta.env.VITE_DATA_REGISTRY_ADDRESS,
    ...
    VITE_RELAY_WALLET_ADDRESSES: import.meta.env.VITE_RELAY_WALLET_ADDRESSES,
    VITE_SUI_DEPLOYER_ADDRESS: import.meta.env.VITE_SUI_DEPLOYER_ADDRESS,
    VITE_SUI_SUB_WALLET_ADDRESSES: import.meta.env.VITE_SUI_SUB_WALLET_ADDRESSES,
};
